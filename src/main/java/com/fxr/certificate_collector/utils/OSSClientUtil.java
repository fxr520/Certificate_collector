...
public class OSSClientUtil {
    ...
    // Bucket名称
    private String bucketName = "certificate-picture";
    // 文件存储目录
     ...
     * @param url
     */
    public void uploadImg2Oss(String url) throws DomainException {
        ...
        try {
            ...
            throw new DomainException(ResultCode.IMAGE_UPLOAD_FAILED);
        }
    }

    public String uploadImg2Oss(MultipartFile file) throws DomainException {
        if (file.getSize() > 20 * 1024 * 1024) {
            throw new DomainException(ResultCode.PICTURE_TOO_BIG);
        }
